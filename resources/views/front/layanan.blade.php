                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow overflow-hidden flex flex-col h-full">
                    ...
                    <div class="p-5 flex flex-col flex-grow">
                        ...
                        <div class="mt-auto pt-4">
                            @if($item->slug)
                                <a href="{{ route('reservasi.create', ['type' => $item->type === 'paket' ? 'paket' : 'layanan', 'slug' => $item->slug]) }}" class="w-full inline-flex justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-pink-500 rounded-lg hover:bg-pink-600 focus:ring-4 focus:outline-none focus:ring-pink-300">
